...
<p class=MsoNormal align=center style='text-align:center; font-family: Verdana; color:Cyan;'>
...
style='color:cyan;'> client-level </span> user. Please enter any valid SQL query or update command in the box below.
    </p>

<textarea id="userinput" name="userinput" rows="10" cols="200" style = "background-color: #292929; font-family: Verdana; color: white">
